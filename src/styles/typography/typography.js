...
const typography = {
  ...
  subtitle1Strong: {
    fontFamily: tokens.fontApplicationSSubtitle1StrongFontFamily,
    fontSize: tokens.fontApplicationSSubtitle1StrongFontSize,
    fontWeight: tokens.fontApplicationSSubtitle1StrongFontWeight,
    lineHeight: tokens.fontApplicationSSubtitle1StrongLineHeight,
    letterSpacing: tokens.fontApplicationSSubtitle1StrongLetterSpacing,
    textTransform: tokens.fontApplicationSSubtitle1StrongTextTransform,
    [breakpoints.up('l')]: {
      fontFamily: tokens.fontApplicationLSubtitle1StrongFontFamily,
      fontSize: tokens.fontApplicationLSubtitle1StrongFontSize,
      fontWeight: tokens.fontApplicationLSubtitle1StrongFontWeight,
      lineHeight: tokens.fontApplicationLSubtitle1StrongLineHeight,
      letterSpacing: tokens.fontApplicationLSubtitle1StrongLetterSpacing,
      textTransform: tokens.fontApplicationLSubtitle1StrongTextTransform,
    },
  },
  subtitle2: {
  ...
  subtitle2Strong: {
    fontFamily: tokens.fontApplicationSSubtitle2StrongFontFamily,
    fontSize: tokens.fontApplicationSSubtitle2StrongFontSize,
    fontWeight: tokens.fontApplicationSSubtitle2StrongFontWeight,
    lineHeight: tokens.fontApplicationSSubtitle2StrongLineHeight,
    letterSpacing: tokens.fontApplicationSSubtitle2StrongLetterSpacing,
    textTransform: tokens.fontApplicationSSubtitle2StrongTextTransform,
    [breakpoints.up('l')]: {
      fontFamily: tokens.fontApplicationLSubtitle2StrongFontFamily,
      fontSize: tokens.fontApplicationLSubtitle2StrongFontSize,
      fontWeight: tokens.fontApplicationLSubtitle2StrongFontWeight,
      lineHeight: tokens.fontApplicationLSubtitle2StrongLineHeight,
      letterSpacing: tokens.fontApplicationLSubtitle2StrongLetterSpacing,
      textTransform: tokens.fontApplicationLSubtitle2StrongTextTransform,
    },
  },
  body1: {
  ...
  body1Strong: {
    fontFamily: tokens.fontApplicationSBody1StrongFontFamily,
    fontSize: tokens.fontApplicationSBody1StrongFontSize,
    fontWeight: tokens.fontApplicationSBody1StrongFontWeight,
    lineHeight: tokens.fontApplicationSBody1StrongLineHeight,
    letterSpacing: tokens.fontApplicationSBody1StrongLetterSpacing,
    textTransform: tokens.fontApplicationSBody1StrongTextTransform,
    [breakpoints.up('l')]: {
      fontFamily: tokens.fontApplicationLBody1StrongFontFamily,
      fontSize: tokens.fontApplicationLBody1StrongFontSize,
      fontWeight: tokens.fontApplicationLBody1StrongFontWeight,
      lineHeight: tokens.fontApplicationLBody1StrongLineHeight,
      letterSpacing: tokens.fontApplicationLBody1StrongLetterSpacing,
      textTransform: tokens.fontApplicationLBody1StrongTextTransform,
    },
  },
  body2: {
  ...
  body2Strong: {
    fontFamily: tokens.fontApplicationSBody2StrongFontFamily,
    fontSize: tokens.fontApplicationSBody2StrongFontSize,
    fontWeight: tokens.fontApplicationSBody2StrongFontWeight,
    lineHeight: tokens.fontApplicationSBody2StrongLineHeight,
    letterSpacing: tokens.fontApplicationSBody2StrongLetterSpacing,
    textTransform: tokens.fontApplicationSBody2StrongTextTransform,
    [breakpoints.up('l')]: {
      fontFamily: tokens.fontApplicationLBody2StrongFontFamily,
      fontSize: tokens.fontApplicationLBody2StrongFontSize,
      fontWeight: tokens.fontApplicationLBody2StrongFontWeight,
      lineHeight: tokens.fontApplicationLBody2StrongLineHeight,
      letterSpacing: tokens.fontApplicationLBody2StrongLetterSpacing,
      textTransform: tokens.fontApplicationLBody2StrongTextTransform,
    },
  },
  button: {
  ...
  captionStrong: {
    fontFamily: tokens.fontApplicationSCaptionStrongFontFamily,
    fontSize: tokens.fontApplicationSCaptionStrongFontSize,
    fontWeight: tokens.fontApplicationSCaptionStrongFontWeight,
    lineHeight: tokens.fontApplicationSCaptionStrongLineHeight,
    letterSpacing: tokens.fontApplicationSCaptionStrongLetterSpacing,
    textTransform: tokens.fontApplicationSCaptionStrongTextTransform,
    [breakpoints.up('l')]: {
      fontFamily: tokens.fontApplicationLCaptionStrongFontFamily,
      fontSize: tokens.fontApplicationLCaptionStrongFontSize,
      fontWeight: tokens.fontApplicationLCaptionStrongFontWeight,
      lineHeight: tokens.fontApplicationLCaptionStrongLineHeight,
      letterSpacing: tokens.fontApplicationLCaptionStrongLetterSpacing,
      textTransform: tokens.fontApplicationLCaptionStrongTextTransform,
    },
  },
  overline: {
